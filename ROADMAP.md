...
- 一秒测试音、自动／手动音频路由和本地使用统计已实现并通过自动化、BlackHole 录回、统计开关与重启持久化验收；按 `goals/20260922-0109-voice-test-routing-usage-stats.md` 仍待完成确认清空、两种路由各 2 次真实遥控器语音、Home／TV 精确计数及键盘全控焦点验收。
