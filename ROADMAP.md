...
- 一秒测试音、自动／手动音频路由和本地使用统计已实现并通过自动化与 BlackHole 录回；仍待授予输入监控／辅助功能权限后，按 `goals/20260922-0109-voice-test-routing-usage-stats.md` 完成两种路由各 2 次真实遥控器语音、Home／TV 精确计数及清空确认验收。
